...
Minecraft 1.21 (NeoForge). It allows modpack creators to
...
- NeoForge Events: Fires StageEvent.Unlocked/Locked events for
...
- tags: List of item tags to lock (e.g. "c:ores/iron").
...
----------------------------------------------------------------
8. NEOFORGE EVENTS (FOR MOD/SCRIPT AUTHORS)
----------------------------------------------------------------

History Stages fires custom NeoForge events on the EVENT_BUS:
...
- Optional: Lootr (loot container integration)
