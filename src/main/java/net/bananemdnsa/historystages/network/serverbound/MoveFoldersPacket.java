 ...
 */
public class MoveFoldersPacket {
    ...
    public MoveFoldersPacket(boolean individual, List<String> paths, String targetParent) {
        this.individual = individual;
        this.paths = paths;
        this.targetParent = targetParent;
    }

    public static void encode(MoveFoldersPacket msg, FriendlyByteBuf buffer) {
    ...
    public static MoveFoldersPacket decode(FriendlyByteBuf buffer) {
    ...
    public static void handle(MoveFoldersPacket msg, Supplier<NetworkEvent.Context> ctx) {
        ctx.get().enqueueWork(() -> {
