 ...
 * depends on any third-party type at compile time. Custom-action mods (e.g. spell casters)
 * whose actions bypass vanilla interaction events are handled here, isolated from the generic
 * lock handlers.
 */
