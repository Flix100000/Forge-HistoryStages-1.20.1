...
public class MultiBlockTier4Block extends MultiBlockResearchPedestalBlock {
    public static final MapCodec<MultiBlockTier4Block> CODEC = simpleCodec(MultiBlockTier4Block::new);
    ...
    public MultiBlockTier4Block(Properties props) {
        super(props);
    }
    ...
    private static VoxelShape makeFoot() {
        ...
        s = Shapes.or(s, footBox(0.1875, 0.1875, 0.1875, 1.8125, 0.625, 0.8125));
        s = Shapes.or(s, footBox(0, 0, 0, 2, 0.1875, 1));
        s = Shapes.or(s, footBox(0, 0.625, 0, 2, 0.9375, 1));
        // Pedestal 1
        ...
        // Walls
        s = Shapes.or(s, footBox(0.375, 0.94375, -0.00625, 1.625, 0.94375, 1.00625));
        s = Shapes.or(s, footBox(0.375, 0.25625, 1.00625, 1.625, 0.94375, 1.00625));
        s = Shapes.or(s, footBox(0.375, 0.25625, -0.00625, 1.625, 0.94375, -0.00625));
        return s;
    }
    ...
    private static VoxelShape makeHead() {
        ...
        s = Shapes.or(s, headBox(0.375, 0.94375, -0.00625, 1.625, 0.94375, 1.00625));
        s = Shapes.or(s, headBox(0.375, 0.25625, 1.00625, 1.625, 0.94375, 1.00625));
        s = Shapes.or(s, headBox(0.375, 0.25625, -0.00625, 1.625, 0.94375, -0.00625));
        return s;
    }
}
