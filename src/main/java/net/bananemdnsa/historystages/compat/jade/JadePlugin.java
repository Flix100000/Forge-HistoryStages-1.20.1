...
public class JadePlugin implements IWailaPlugin {
    ...
    private static final ResourceLocation PEDESTAL_BOOSTER = new ResourceLocation(HistoryStages.MOD_ID, "pedestal_booster");
        ...
        public void appendTooltip(ITooltip tooltip, BlockAccessor accessor, IPluginConfig config) {
            ...
            if (hidden.changesName()) {
                Component replacement = hidden.nameMode() == DisplayMode.REPLACE
                        ...
                        : Component.empty();
                // This Jade version has no replace(id, Component); emulate it by removing the
                // existing object-name line and re-inserting the replacement under the same id.
