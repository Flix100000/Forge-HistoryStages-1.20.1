 ...
 * to cancel first — cancelled deaths never reach this handler (Forge does not
 * invoke listeners for a cancelled {@link LivingDeathEvent} unless they opt in
 * with {@code receiveCanceled}, which this handler does not).</p>
 *
