...
cd History-Stages
git checkout fabric-1.21.X   # or the branch you're targeting
./gradlew build
```
...
History Stages is **All Rights Reserved** (see [LICENSE](LICENSE)). The source is public for
...
Every merged contribution gets an entry in [CONTRIBUTORS.md](https://github.com/Flix100000/History-Stages/blob/neoforge-1.21.X/CONTRIBUTORS.md) — code, translations, art and
